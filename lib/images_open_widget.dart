...
class _GalleryImageViewWrapperState extends State<GalleryImageViewWrapper> {
  ...
  Widget build(BuildContext context) {
    ...
    bool loader = false;
    // List<GalleryItemModel> galleryItems = widget.galleryItems.map((e) {
    //   var indxx = widget.galleryItems!.indexOf(e);
    //   // print ('${getIt<StateManager>().generateRandomString()} $indxx ${e.imgName}');
    //   return GalleryItemModel(id: '${getIt<StateManager>().generateRandomString()}',index: indxx,imageUrl: e.imageUrl );
    //
    //
    // }).toList();
                ...
                child: GestureDetector(
                  ...
                  child: PageView.builder(
                    ...
                    itemBuilder: (context, index) =>
                        _buildImage(widget.galleryItems[index], loader),
                  ),
                ),
              ),
