...
class AnatomyScreen extends StatefulWidget {
  final int bookingId;
  const AnatomyScreen({super.key, required this.bookingId});
...
class _AnatomyScreenState extends State<AnatomyScreen> {
  ...
  Widget build(BuildContext context) {
    bool? isShowSmallPoints =
        Provider.of<OnlineConsultManager>(context).showSmallPoints;
    String? selectedId =
        Provider.of<OnlineConsultManager>(context).selectedPositionId;
    ...
    getPositionWid(
        {required double top, required double left, required bool? visible}) {
      return Visibility(
        ...
        child: Positioned(
          ...
          child: GestureDetector(
            onTap: () {
              _zoomToPoint(Offset(left, top),
                  4.0); // Zoom to the specific region with scale 3.0
              getIt<OnlineConsultManager>().setShowSmallPoints(true);
            ...
            child: AvatarGlow(
              glowRadiusFactor: 1, glowColor: Colors.red,

              // repeat:false,
              animate: false, glowCount: 2,
              // endRadius: 60.0,
    ...
    getSmallPositionWid(
      ...
      return Visibility(
        ...
        child: Positioned(
          ...
          child: GestureDetector(
            onTap: () {
              getIt<OnlineConsultManager>().setSelectedSmallPoint(positionId);

              // _zoomToPoint(Offset(left, top), 4.0); // Zoom to the specific region with scale 3.0
            ...
            child: AvatarGlow(
              glowRadiusFactor: 1,
              glowColor:
                  selectedId == positionId ? Colors.green : Colors.transparent,
    ...
    btnWidget({required String title}) {
      return Container(
        ...
        decoration: BoxDecoration(
            border: Border.all(
                color: const Color(0xffEB0000).withOpacity(0.4), width: 0.5),
        ...
        child: Padding(
          ...
          child: Center(
              child: Text(
            title,
            style: TextStyles.textStyleAnatomy2,
          )),
        ),
      );
    }
          ...
          child: InteractiveViewer(
            ...
            onInteractionUpdate: (sds) {
              ...
              if (currentScale > 2.5 && isShowSmallPoints != true) {
                ...
                getIt<OnlineConsultManager>().setShowSmallPoints(false);
              }
            },
            ...
            child: Stack(
              children: [
                // Main Anatomy Image
                Image.asset(
                  cacheWidth: w.round() * 4, cacheHeight: h.round() * 4,
    ...
    List<PositionModel> mainPoints = [
      PositionModel(
          id: "A1", top: h * 0.04, left: w * 0.42, visible: isShowSmallPoints),
      PositionModel(
          id: "A2", top: h * 0.20, left: w * 0.54, visible: isShowSmallPoints),
      PositionModel(
          id: "A3", top: h * 0.25, left: w * 0.27, visible: isShowSmallPoints),
      PositionModel(
          id: "A4", top: h * 0.35, left: w * 0.40, visible: isShowSmallPoints),
      PositionModel(
          id: "A5", top: h * 0.50, left: w * 0.40, visible: isShowSmallPoints)
    ];
    ...
    List<PositionModel> smallPoints = [
      PositionModel(
          ...
          top: h * 0.05,
          left: w * 0.50,
          visible: isShowSmallPoints), //head
      PositionModel(
          id: "B2",
          top: h * 0.08,
          left: w * 0.50,
      ...
      PositionModel(
          ...
          top: h * 0.25,
          left: w * 0.29,
          visible: isShowSmallPoints), //hand
      PositionModel(
          id: "B10",
          top: h * 0.33,
          left: w * 0.25,
            ...
            const Entry(
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style: TextStyles.textStyleAnatomy3,
                ),
              ),
            ),
            FlipCard(
              ...
              frontWidget:
                  getCard('assets/images/human-body-frontal.jpg', points: [
                ...mainPoints
                    .map((e) => getPositionWid(
                        visible: e.visible, left: e.left, top: e.top))
                    .toList(),
                ...smallPoints
                    .map((e) => getSmallPositionWid(
                        positionId: e.id,
                        visible: e.visible,
                        left: e.left,
                        top: e.top))
              ...
              backWidget: getCard('assets/images/human-body-back.jpg', points: [
                ...mainPoints
                    .map((e) => getPositionWid(
                        visible: e.visible, left: e.left, top: e.top))
                    .toList(),
              ...
              child: Row(children: [
                Expanded(
                  child: InkWell(
                      ...
                      child: btnWidget(
                          title: flipCntrlr.state?.isFront == false
                              ? "Turn Body"
                              : "Turn Body")),
                ),
                horizontalSpace(8),
                Expanded(
                  child: InkWell(
                      onTap: () {
                        getIt<OnlineConsultManager>().shareAnatomyImage(
                            bookId: widget.bookingId,
                            imageName: "image",
                            left: "3",
                            top: "3");
                                            },
                      child: btnWidget(title: "Share")),
                ),
              ]),
            ),
          ],
...
//
//   DetailedView({required this.partName, required this.imagePath});
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
//             // Detailed Part Image
//             ModelViewer(
//               src: 'assets/models/11091_FemaleHead_v4.obj', // Ensure the model is in your assets
//               // autoRotate: true,
//               cameraControls: true,
//             ),
//
